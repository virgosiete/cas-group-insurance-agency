...
export default function TestimonialCard({ quote, name, title, initials }: TestimonialCardProps) {
  return (
    <div className="p-8 bg-white border-2 border-brand-lightGray rounded-lg hover:shadow-lg hover:border-brand-borderGray transition-all duration-200">
      <Quote className="w-10 h-10 text-primary-300 mb-4" />
      <p className="text-primary-700 mb-6 leading-relaxed italic">{quote}</p>
      <div className="flex items-center">
        <div className="w-12 h-12 rounded-full bg-brand-lightGray flex items-center justify-center mr-4">
